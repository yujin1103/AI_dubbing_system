...
F0_JUMP_TH = float(__import__("os").environ.get("WORD_F0_JUMP", "100"))         # F0 차 Hz
LR_COS_STRICT = float(__import__("os").environ.get("WORD_LR_COS", "0.35"))     # F0 jump 함께면 이 threshold
SIM_BOTH_MIN = float(__import__("os").environ.get("WORD_SIM_BOTH", "0.40"))      # 양쪽 sim 모두 이 이상
